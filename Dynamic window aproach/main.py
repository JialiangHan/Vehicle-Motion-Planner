...
class Config:
    ...
    def __init__(self):
        ...
        self.max_steering_angle = 40.0 * math.pi / 180.0  # [rad/s]
        self.max_accel = 0.2  # [m/ss]
        self.max_steering_angle_rate = 40.0 * math.pi / 180.0  # [rad/ss]
        self.v_resolution = 0.01  # [m/s]
        self.steering_angle_resolution = 0.1 * math.pi / 180.0  # [rad/s]
