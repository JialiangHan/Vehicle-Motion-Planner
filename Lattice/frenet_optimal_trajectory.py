...
def calc_global_paths(fplist, csp):
    for fp in fplist:
        ...
        for i in range(len(fp.s)):
            # get corresponding ref cartesian coordinate, ix,iy
            ix, iy = csp.calc_position(fp.s[i])
            if ix is None:
                break
            i_yaw = csp.calc_yaw(fp.s[i])
            di = fp.d[i]
            # fx,fy are cartesian coordinate for trajectory
...
def check_collision(fp, ob):
    # calculate distance from trajectory to obstacle
...
def main():
    ...
    # generate reference line: cubic spline: natural spline
    # tx,ty are cartesian coordinate for ref line
    # tyaw are yaw angle/heading angle
    # tc are curvature
    # csp are cubic spline class
